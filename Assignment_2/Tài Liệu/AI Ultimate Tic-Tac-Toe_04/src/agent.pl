...
%
% this is where the search strategy is!
search(_P,L,Board,Move) :-
   findall(M,legal(L,M,Board),List),
   random_member(List,Move).

% heuristic ideas
% simpler version of the game - big tic tac toe
% 1. prioritise getting 3 in row in current board
% 2. prioritise blocking opponent
% 3. then prioritise
